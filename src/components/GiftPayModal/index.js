			...
			if (result.isConfirmed) {
				Swal.fire({
					...
					didOpen: async () => {
						Swal.showLoading();
						try {
							const res = await petitions.postDedicatoria(
								dedicationsJson
							);
				...
				<FormContainer>
					...
					<MiniInputsContainer>
						<MiniInputForm
							...
							placeholder="Fecha de Expiracion"></MiniInputForm>
						<MiniInputForm
							name="card_cvc"
							placeholder="CVC"
							type={"number"}></MiniInputForm>
					</MiniInputsContainer>
					<TextAreDedicatoria
						name="card_dedicatoria"
						placeholder="dedicatoria"></TextAreDedicatoria>
