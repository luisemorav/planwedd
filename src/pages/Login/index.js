    ...
    return(
        <div className='backgroundImage2' style={{with:'100%',height:'100%'}}>
            <div className="container" style={{maxWidth:'700px', height:'100vh', display:'flex', flexDirection:'column',justifyContent:'center'}} >
                <div className="container card p-5" style={{background:'rgba(255, 255, 255, 0.25)',backdropFilter:'blur(10px)'}}>
                    <div className="container" style={{display:'flex', flexDirection:'column',textAlign:'center'}}>
                        ...
                        <p style={{fontSize:'1em'}}>o si no tienes una cuenta 
